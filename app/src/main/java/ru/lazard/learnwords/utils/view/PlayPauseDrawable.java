package ru.lazard.learnwords.utils.view;
...
public class PlayPauseDrawable extends Drawable {
    ...
    public PlayPauseDrawable(Context context) {
        ...
        mPauseBarWidth = mPauseBarHeight/3;//res.getDimensionPixelSize(R.dimen.pause_bar_width);
        mPauseBarDistance  = mPauseBarHeight/3;//res.getDimensionPixelSize(R.dimen.pause_bar_width);
    ...
    public Animator getPausePlayAnimator(float from,float to) {
        final Animator anim = ObjectAnimator.ofFloat(this, PROGRESS,from,to);
    ...
    public Animator getAnimatorToPause() {
        mIsPlay=true;
       return getPausePlayAnimator(getProgress(),0);
    }
    public Animator getAnimatorToPlay() {
        mIsPlay=false;
        return getPausePlayAnimator(getProgress(),1);
    }
